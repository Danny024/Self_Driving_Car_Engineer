...
![Point Cloud with images](image_results/mid_project/sequence3_with_pcl.png)

![Point Cloud with Images2](image_results/mid_project/image_and_pcl.png)
...
![Image height bev](image_results/mid_project/image_height_bev.png)

The image intensity map of the BEV
![Intensity Map](image_results/mid_project/intensity_map.png)
...
![Image Label](image_results/mid_project/frame_0.png)

The label and the detected objects can be seen in the figure below
![labels and dtetected objects](image_results/mid_project/labelsvsobjects.png)
...
![Metrics](image_results/mid_project/metrics.png)
